...
max(bw1) #491269.2
V(movies_actors_graph)$name[which(bw == max(bw1))] # Lawrance of Arabia: Interesting phenomenon, worth checking or error
...
summary(bw) # There is no betweenness for any vertex
max(bw) # 0
V(movies_actors_graph)$name[which(bw == max(bw1))] # Every vertex is here
